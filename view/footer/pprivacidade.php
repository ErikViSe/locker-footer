...
<div class="container">
    ...
    <p><br>1. Dados que coletamos e motivos da coleta<br></p>

    <p>Nós coletamos os seguintes dados pessoais que nossos usuários nos fornecem expressamente ao utilizar nosso site:</p>

    <p style="padding-left: 30px;"><span id="span_id_dados_fornecidos_especifica">- Nome Completo;<br>- CPF;<br>- Email;<br>- RM;<br>- Telefone.</span></p>

    <p>A coleta destes dados ocorre nos seguintes momentos:</p>
    <p style="padding-left: 30px;"><span id="span_id_dados_fornecidos_momento">Cadastro.</span></p>

    <p>Os dados fornecidos por nossos usuários são coletados com as seguintes finalidades:</p>

    <p style="padding-left: 30px;"><span id="span_id_dados_fornecidos_finalidade">- Para que o usuário possa adquirir nossos produtos;<br>- Para que possamos entrar em contato com o cliente;</span></p>

    <p><em>2. Dados sensíveis</em></p>

    <p><strong>Não</strong> serão coletados dados sensíveis de nossos usuários, assim entendidos aqueles definidos nos arts. 
    11 e seguintes da Lei de Proteção de Dados Pessoais. Assim, <strong>não</strong> haverá coleta de dados sobre origem racial ou étnica, convicção religiosa, opinião política, filiação a
    sindicato ou a organização de caráter religioso, filosófico ou político, dado referente à saúde ou à vida sexual, dado genético ou biométrico, quando vinculado a uma pessoa natural.</p>
    ...
    <p><span class="flou"><strong><strong><br></strong></strong></span><strong>3.</strong> <strong>Por quanto tempo seus dados pessoais serão armazenados</strong></p>

    <p>Os dados pessoais coletados pelo site são armazenados e utilizados por período de tempo que corresponda ao necessário para atingir as
    finalidades elencadas neste documento e que considere os direitos de seus titulares, os direitos do controlador do site e as disposições legais ou regulatórias aplicáveis.</p>

    <p>Uma vez expirados os períodos de armazenamento dos dados pessoais, eles são removidos de nossas bases de dados ou anonimizados,
    salvo nos casos em que houver a possibilidade ou a necessidade de armazenamento em virtude de disposição legal ou regulatória.</p>

    <!-- 4. -->

    <p><span class="flou"><strong><strong><br></strong></strong></span><strong>4. Bases legais para o tratamento de dados pessoais<span class="flou"><br></span></strong></p>
    ...
    <p>Todas as Nossas atividades de tratamento de dados pessoais possuem uma base legal que as fundamenta, dentre as permitidas pela legislação. 
    Mais informações sobre as bases legais que utilizamos para operações de tratamento de dados pessoais específicas podem ser obtidas a partir de nossos canais de contato, informados ao final desta Política.</p>

    <!-- 5. -->



    <p><br><strong><strong>5.</strong></strong><strong> Medidas de segurança no tratamento de dados pessoais<br></strong></p>
    ...
    <p><strong><br>6. Alterações nesta política<br></strong></p>
    <p>A presente versão desta Política de Privacidade foi atualizada pela última vez em: <span id="span_id_data_termo">13/11/2022</span>.</p>
